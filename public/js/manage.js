...
function renderManageDecide(
    ...
    switch (currentStepTitle.split(" ")[1]) {
        case "環境結構":
            missionExplainContent.html("環境結構")
            break
        case "學習策略":
            missionExplainContent.html("學習策略")
            break
        case "時間管理":
            missionExplainContent.html("時間管理")
            break
        case "尋求協助":
            missionExplainContent.html("尋求協助")
            break
        case "自我評估":
            missionExplainContent.html("自我評估")
            break
    }
