...
function renderDataPage(data) {
    ...
    dataDownload.append(
        renderDownloadPDFandVideo(
            data.thisWeekData.pdf,
            data.thisWeekData.video
        )
    )

    dataThisWeekPoint.append(
        renderThisWeekPoint(data.thisWeekData.thisWeekPoint)
    )
